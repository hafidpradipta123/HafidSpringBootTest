...
public class ContentJdbcTemplateRepository {
    ...
    private final JdbcTemplate jdbcTemplate; // this is
    ...
    private void createContent(String title, String desc, String status, String contentTpye, String URL ){
        String sql = "INSERT INTO Content (" +
                "title, desc, status, content_type, date_created, URL) " +
                "VALUES (?,?,?,?, NOW(), ?)";
        jdbcTemplate.update(sql, title, desc, status, contentTpye, URL);
    }
